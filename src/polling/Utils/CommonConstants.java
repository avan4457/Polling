...
public class CommonConstants {
	...
	public static final String QUERY_ID_GET_VOTER = "voter_by_id";// "select *
																	// from
																	// voter
																	// where
																	// id=?"

	public static final String QUERY_ID_UPDATE_VOTER = "update_voter_by_id";// "update
																			// voter
																			// set
																			// district=?,status=?
																			// where
	...
	public static final String QUERY_ID_INSERT_VOTER = "insert_voter";// "insert
																		// into
																		// voter
																		// values(?,?,?)"

	public static final String QUERY_ID_GET_ELECTION = "get_current_election"; // "select
																				// *
																				// from
																				// election
																				// where
	...
	public static final String QUERY_ID_CHECKED_VOTES_TABLE = "checked_votes_table"; // "select
																						// *
																						// from
																						// votes
																						// where
	...
	public static final String QUERY_ID_GET_ELECTION_ID_BY_NAME = "election_id_by_name"; // conflict//"select
																							// *
																							// from
																							// election
																							// where
	...
	public static final String QUERY_ID_DELETE_VOTER_BY_ID = "delete_voter"; // "delete
																				// from
																				// voter
																				// where
																				// id=
	...
	public static final String QUERY_ID_GET_CANDIDATE_LIST = "candidate_list"; // "select
																				// c.userId,
																				// u.name
																				// ,c.candidateNum
																				// from
	...
	public static final String QUERY_ID_GET_CANDIDATE_LIST_WITH_PARTY = "candidate_list_with_party"; // "select
																										// c.userId,
																										// u.name,c.party,c.candidateNum
																										// from
																										// candidate
																										// c,user
																										// u
	...
	public static final String QUERY_ID_GET_PARTIES = "get_parties";// "select
																	// DISTINCT
																	// party
																	// from
																	// candidate
	...
	public static final String QUERY_ID_INSERT_VOTES = "insert_into_votes"; // "insert
																			// into
																			// votes
																			// values(?,?)"

	public static final String QUERY_ID_CHECKED_RESULTS = "checked_results_table"; // "select
																					// *
																					// from
																					// results
																					// where
	...
	public static final String QUERY_ID_UPDATE_RESULTS = "update_results_table"; // "update
																					// results
																					// set
																					// count
																					// =
	...
	public static final String QUERY_ID_INSERT_RESULTS = "insert_into_results";// "insert
																				// into
																				// results
																				// values(?,?,?)"

	public static final String QUERY_ID_CHECKED_PARTYVOTES = "checked_partyvotes_table";// "select
																						// *
																						// from
																						// partyvotes
																						// where
	...
	public static final String QUERY_ID_UPDATE_PARTYVOTES = "update_partyvotes_table";// "update
																						// partyvotes
																						// set
																						// count
																						// =
	...
	public static final String QUERY_ID_INSERT_PARTYVOTES = "insert_into_partyvotes";// "insert
																						// into
																						// partyvotes
																						// values(?,?,?)"

	public static final String QUERY_ID_GET_CANDIDATE_LIST_WITH_status = "candidate_list_with_status";// "select
																										// c.userId,
																										// u.name,c.party,c.candidateNum
																										// from
																										// candidate
