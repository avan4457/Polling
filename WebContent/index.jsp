		...
		<form action="AddUserServlet" method="POST">
			<div class="form-group" id="frmSignup">
				<h2 style="text-align: center;">
					<b>New? Register Now..</b>
				</h2>
				<p>
					*<%=res%></p>
				<br> Full Name : <input type="Text" name="name"
					class="form-control" placeholder="eg:John Smith" /><%=msg%><br>
				<br> NIC No : <input type="text" name="nic"
					class="form-control" placeholder="eg:982033567v" /><%=msg%><br>
				<br> Email : <input type="text" name="email"
					class="form-control" placeholder="eg:john@sample.com" /><%=msg%><br>
				<br> Password : <input type="password" name="password"
					class="form-control" placeholder="New password.." /><%=msg%><br>
				<br> Phone Number : <input type="text" name="phone"
					class="form-control" placeholder="eg:071-1234578" /><br>
		...
		<form action="LogInUserServlet" method="POST">
			<div class="form-group" id="frmLogin">
				...
				Email : <input type="text" name="email" class="form-control"
					placeholder="eg:john@sample.com" /><br>
				<br> Password : <input type="password" name="password"
